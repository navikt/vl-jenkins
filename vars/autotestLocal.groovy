        ...
        node('VTPAUTOTEST') {
            ...
            try {
                ...
                stage("Start VTP") {
                    ...
                    sh "docker run -d --name fpmock2 --env-file vtp.env -v $workspace/.modig:/app/.modig -p 8636:8636 -p 8063:8063 -p 8060:8060 -p 8001:8001 ${dockerRegistry}/fpmock2:${vtpVersjon}"
                }
